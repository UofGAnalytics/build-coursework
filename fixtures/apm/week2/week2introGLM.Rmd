...
\label{def:scoreuniv}$U=\dfrac{dl(\theta;y)}{d\theta}$ is called the \textbf{score statistic}, and is equal to the derivative of the log-likelihood $l(\theta;y)$ with respect to the parameter $\theta$.
###[/definition]
