...
Possibly the simplest scenario of a predictive model is that when we want to estimate a model that predicts a response variable based on existing predictor variables which display a linear relationship to the variable of interest (you have covered a lot of similar examples in *Predictive modeling*). 

###[example] Birthweight - linear model


The data in this example consists of the *birthweight* (in grams) and *gestational age* (in weeks) for 12 boys (*sex* = 1) and 12 girls (*sex* = 2). We will remind you how to fit a linear models on this data.
