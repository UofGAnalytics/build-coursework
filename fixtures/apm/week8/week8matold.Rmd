...
lines(366:465, model.predict$fit[ ,2], lty=2, col="#fd8d3c")
lines(366:465, model.predict$fit[ ,3], lty=2, col="#fd8d3c")
...
Exponential smoothing is a simple procedure that does not assume a parametric model for the data, and is similar to moving average smoothing discussed in Week 6. It makes one-step ahead forecasts of the form
