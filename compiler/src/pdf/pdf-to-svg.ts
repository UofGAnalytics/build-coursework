// This tool provided minimal value and was constantly
// causing issues with new Node.js ESM modules, so
// disabling this functionality until pdf.js provides
// a neater node module.
// Also: https://github.com/dawbarton/pdf2svg
...
//     url: path.join(process.cwd(), filePath),
